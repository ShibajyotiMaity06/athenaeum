        ...
        <div className="manuscript text-[var(--text-primary)] space-y-8">
          ...
          <section>
            ...
            <ol>
              ...
              <li>Visit our <a href="/contact" className="text-[var(--accent)] font-mono font-bold underline">Contact Desk</a> with your Razorpay Payment ID. We resolve and activate licenses within 2 to 4 business hours.</li>
            </ol>
          </section>
        </div>
      </div>
